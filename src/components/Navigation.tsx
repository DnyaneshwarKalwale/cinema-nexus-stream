...
import { Search, Home, Film, Tv, X, Menu, Bookmark } from 'lucide-react';
...
const Navigation: React.FC<NavigationProps> = ({ inModalView = false }) => {
  ...
  if (isMobile) {
    return (
      <>
        {/* Mobile Navigation */}
        <nav className={`fixed left-0 right-0 z-50 bg-black/95 backdrop-blur-xl border-b border-gray-800/50 transition-all duration-300 ${
              ...
              <div className="mt-3 animate-fade-in">
                <form onSubmit={handleSearchSubmit} className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 backdrop-blur-sm text-white pl-10 pr-10 py-3 rounded-xl border border-white/20 focus:border-blue-500 focus:outline-none placeholder-gray-400"
                    autoFocus
                  />
                  {searchQuery && (
                    <button
        ...
        {/* Mobile Menu Overlay */}
        {isMobileMenuOpen && (
          <div className="fixed inset-0 z-40 bg-black/90 backdrop-blur-sm animate-fade-in">
            <div className={`absolute right-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-l border-gray-800/50 transform transition-transform duration-300 ${
              isAnnouncementEnabled && !inModalView ? 'pt-[108px]' : 'pt-[60px]'
            }`}>
              <div className="p-6">
                ...
                <div className="mt-8 pt-8 border-t border-gray-800/50">
                  <a
                    ...
                    className="flex items-center gap-4 px-4 py-4 rounded-xl text-gray-300 hover:bg-white/10 hover:text-white transition-all"
                  >
